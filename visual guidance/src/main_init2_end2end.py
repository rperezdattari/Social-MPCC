...
parser.add_argument('--config-file', default='Carla_HGDAgger_full2_end2end', help='select file in config_files folder')
parser.add_argument('--exp-num', default='-1')
parser.add_argument('--testing', type=bool, default=True, help='test flag')
...
if config_general['env_type'] == 'ROS':
    import rospy
    from carla_env_end2end import CarlaEnv
