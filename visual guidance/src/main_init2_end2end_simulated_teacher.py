...
parser.add_argument('--config-file', default='Carla_HGDAgger_full2_end2end_simulated_teacher', help='select file in config_files folder')
...
if config_general['env_type'] == 'ROS':
    import rospy
    from carla_env_end2end_simulated_teacher import CarlaEnv
